...
1. Технология JavaServer Faces. Особенности, отличия от сервлетов и JSP, преимущества и недостатки. 2. Структура JSF-приложения.
...
<img src="image.png" style="height: 300px; width:400px;"/>
